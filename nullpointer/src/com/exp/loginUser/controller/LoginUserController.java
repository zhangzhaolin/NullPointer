...
public class LoginUserController {
	...
	public String activeLoginUser(@RequestParam(name = "loginActive") boolean active,
			@RequestParam(name = "loginName") String loginName, HttpSession session) {
		...
		String content = "<h4> <small>本页面将于10秒内自动跳转到登录！<a href='login.jsp'>立即跳转</a></small></h4>";
		session.setAttribute("regiserWelcome", "您的注册邮箱为:"+loginUser.getLoginEmail()+",恭喜您激活成功，快去体验nullpointer的美好吧！");
