...
public class LoginUserServiceImpl {
	...
	/**
	 * 功能：
	 * 通过参数name,email,password,将数据插入数据库loginUser,UserInfo中
	 * 同时荣誉值自动增加到10
	...
	public String register(LoginUser loginUser){
		...
		if(result=="0"){
			...
			//邮件内容!
			String activeURL ="http://localhost:8080/nullpointer/loginUser/activeLoginUser?loginActive=true&loginName="+loginUser.getLoginName();
			String emailContent ="<html><head><title>欢迎注册nullpointer</title></head><body>"
					...
					+ "<b>Welcome to nullpointer!</b>"
					+ "</td>"
					+ "</tr>"
					+ "<tr>"
					+ "<td style='padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;'>"
					+ "请点击以下链接完成注册：<b><br/><a href='"
					+ activeURL
