...
public class ImageUtil {
	...
	public static void parseCutedImage(String x, String y, String width, String height, String filetype,
			String filename, String filenameOutput) throws IOException {
		x = checkFormat(x);
		y = checkFormat(y);
		width = checkFormat(width);
		height = checkFormat(height);
		ImageUtil o = new ImageUtil(Integer.parseInt(x), Integer.parseInt(y), Integer.parseInt(width),
