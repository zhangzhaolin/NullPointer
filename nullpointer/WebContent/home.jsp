                                ...
                                <div class="navbar-header">
                                            ...
                                            <div class="collapse navbar-collapse navbar-collapse-example">
                                                      ...
                                                      <ul class="nav navbar-nav navbar-right">
                                                                ...
                                                                <!-- 导航中的下拉菜单 -->
                                                                <li class="dropdown">
                                                                  <a href="${ctx }/your/nice/url" class="dropdown-toggle" data-toggle="dropdown"><img src="${ctx }/images/touxiang.jpg" width="20px" height="20px" class="img-circle"/> <b class="caret"></b></a>
                ...
                <div class="container" style="padding-top: 20px;">
                        <div class="col-md-3 column">
                            ...
                            <div class="col-md-11 column">
                                <div class="example" style="text-align: center;background-color: #fafafa;">
                                    <div class="container">
                                            <img class="img-circle" width="100"  height="100" src="${ctx }/images/touxiang.jpg" alt="头像">
                                ...
                                <div class="col-md-12">
                                    <nav class="menu" data-toggle="menu" style="width: 200px;margin-top:20px;margin-bottom: 20px;">
                                      <ul class="nav nav-primary">
                                        <li class="nav-heading">个人中心</li>
                                        <li class="active"><a href="${ctx }/home.jsp"><i class="icon icon-home"></i> 我的主页</a></li>
                                        <li><a href="${ctx }/accountSetting.html"><i class="icon-user"></i> 账号设置</a></li>
                                        <li><a href="${ctx }/home-question.html"><i class="icon icon-question-sign"></i> 我的问题<span class="label label-badge label-success">4</span></a></li>
                                        <li><a href="${ctx }/home-answer.html"><i class="icon icon-reply"></i> 我的回答<span class="label label-badge label-success">4</span></a></li>
                                        <li><a href="${ctx }/home-comment.html"><i class="icon icon-comments"></i> 我的评论<span class="label label-badge label-success">4</span></a></li>
                                        <li><a href="${ctx }/home-share.html"><i class="icon icon-share"></i> 我的分享<span class="label label-badge label-success">4</span></a></li>
                                      </ul>
                                    </nav>
                                </div>
                        ...
                        <div class="col-md-9 column">
                            <div class="alert alert-success with-icon alert-dismissable">
                                <i class="icon-user"></i>
                                <div class="content">
                                    hi!&nbsp;&nbsp;&nbsp;${userinfo.getLoginUser().getLoginName() }&nbsp;&nbsp;&nbsp;你已经在这里度过了${day}天${hour}小时${min}分${second }秒
                                </div>
                            ...
                            <div class="panel">
                              ...
                              <div class="panel-body">
                                ...
                                <canvas id="Honor" width="500" height="200" style="margin-left: 40px;padding-top: 15px;"></canvas>
                              </div>
                            </div>
                            <div class="panel">
                              <div class="panel-heading">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="col-md-3">
                                            <div class="mb5">
                                                <span class="profile__mod-inner-heading">个人头像</span>
                                            </div>
                                            <div class="avatar avatar-square-128"><img class="img-circle" src="${ctx }/images/touxiang.jpg" width="130" height="130"></div>
                                        </div>
                                            <div class="col-md-4">
                                                <div class="profile__mod-inner-item">
                                                    ...
                                                    <div>
                                                        <span>${userinfo.getLoginUser().getLoginName() }</span>
                                                    </div>
                                                </div>
                                                <div class="profile__mod-inner-item">
                                                    <div>
                                                ...
                                                <div class="profile__mod-inner-item">
                                                    ...
                                                    <div>
                                                        <span>${userinfo.getUserInfoSex() }</span>
                                                    </div>
                                                </div>
                                                <div class="profile__mod-inner-item">
                                                    <div>
                                                    ...
                                                    <div>
                                                        <span>${userinfo.getUserInfoHonorCount() }</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                    <span class="profile__heading-edit pull-right  btn btn-xs" data-type="base"><i class="fa fa-pencil" aria-hidden="true"></i><a href="${ctx }/edit?id=1">编辑</a></span>
                                                    <div class="profile__mod-inner-item">
                                                        <div>
                                                            <span class="profile__mod-inner-heading">邮箱</span>
                                                            <div>
                                                                <span>${userinfo.getLoginUser().getLoginEmail() }</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="profile__mod-inner-item">
                                                    ...
                                                    <div class="profile__mod-inner-item">
                                                        ...
                                                        <div>
                                                            <span>${userinfo.getUserInfoDescribe() }</span>
                                                        </div>
                                                    </div>
                                ...
                                <div id="footer-bottom" class="container">
                                        <div class="row">
                                                <div class="col-md-6 column">
                                                        <p class="copyright">
                                                                Copyright © 2013. All Rights Reserved by KnowledgeBase.Collect from <a href="#" title="EXP" target="_blank">EXP小组</a>
                                                        </p>
                                                </div>
                                                <div class="col-md-6 column">
                                                        <!-- Social Navigation -->
                    ...
                    datasets: [
                        {
                            label: "蓝队",
                            color: 'primary',
                            data: [65, 59, 80, 81, 56, 55, 40,66,66,66,36,69]
                        }
                    ]
                };
                // 图表配置项，可以留空来使用默认的配置
