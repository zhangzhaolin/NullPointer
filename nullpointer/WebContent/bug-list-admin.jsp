	...
	<div class="container" style="padding-top: 20px; padding-bottom: 25px;">
		...
		<div class="col-md-8 column">
			<div class="example">
				<header>
				<h3>
					<i class="icon-list-ul"></i> 官方BUG查询 <small> 共123条</small>
				</h3>
				</header>
				<div class="items items-hover">
					<div class="item">
						<div class="item-heading">
							<h2 class="post-title">
								<a href="bug-detailed.html">ClassNotFoundException</a>
							</h2>
						</div>
		...
		<div class="col-md-4 column" style="margin-top: 30px;">
			...
			<div class="col-md-8">
				...
				<ul class="nav nav-stacked nav-primary" style="margin-top: 20px;">
					<li class="active"><a href="${ctx}/bug-list-admin.jsp">官方BUG查询</a></li>
					<li><a href="${ctx}/bug-list-user.jsp">用户BUG查询</a></li>
				</ul>
			</div>
